...
struct List *newedge (struct List *node, ll int i, ll int w)
{
...
void DFS(ll int s,ll int org,ll int tot)		//needs visited and result
{
    res[org][s]=tot;
    Visited[s]=true;
...
void Bottomupheapify (ll int H[], ll int A[], ll int B[], ll int i)
{
  ll int p = (i - 1) / 2, t;
  ll int temp;
...
void Topdownheapify (ll int H[], ll int A[], ll int B[], ll int i, ll int n)
{
  ll int c, t;
  ll int temp;
...
void Add (ll int H[], ll int A[], ll int B[], ll int X, ll int *n)
{
...
void DeleteMin (ll int H[], ll int A[], ll int B[], ll int *n)
{
  ll int t;
  ll int t1;
  *n = *n - 1;
...
void DecreaseKey (ll int H[], ll int A[], ll int B[], ll int i, ll int X)
{
...
void PrimsMin (struct List *list[], ll int s, ll int n)
{
